<template>
  <v-card :loading="isGetting" class="mx-auto" max-width="100%" tile>
    ...
    <v-card-text>
      ...
      >
          ...
          <v-toolbar flat>
            ...
            <v-dialog v-model="dialog" persistent max-width="500px" eager>
              ...
              <v-card>
                ...
                <v-card-actions>
                  <v-spacer></v-spacer>
                  <v-btn color="#50645A" text @click="close"> Close </v-btn>
                  <v-btn
                    color="#50645A"
                    text
                    :loading="isLoading"
        ...
        <template v-slot:[`item.phone`]="{ item }" class="pa-5">
          <v-icon v-if="item.phone == null" color="" size="25">
            mdi-cancel
          </v-icon>
